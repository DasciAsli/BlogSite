...
namespace FiveSessionWebMvcApp.Areas.ManagementPanel.Helpers
{
    public static class ImageUpload
    {
        ...
        internal static string SaveBase64Image(string base64string, int height, int width, string customImgName = null)
        {
            var _image = Base64ToImage(base64string);
            _image = ImageResizeAndCrop(new Bitmap(_image), width, height);
